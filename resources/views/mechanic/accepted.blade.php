...
<div class="container">
    <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto text-center">
            <h1 class="fw-light">Your current jobs</h1>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $s->description }}</td>
                                <td>
                                    <a href="{{ route('job.complete', $s->id) }}" class="btn btn-primary btn-sm">Complete</button>
                                    <a href="{{ route('job.cancel', $s->id) }}" class="btn btn-danger btn-sm">Cancel</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
